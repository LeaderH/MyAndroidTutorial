    ...
    private void processControllers() {
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (selectedCount > 0) {
                    ...
                    Intent intent = new Intent(Constants.ACTION_EDIT_ITEM);

                    // 設定記事編號與標題
                    intent.putExtra("position", position);
                    intent.putExtra(Constants.CLASS_ITEM, item);

                    // 呼叫「startActivityForResult」，第二個參數action「1」表示執行修改
        ...
        AdapterView.OnItemLongClickListener itemLongListener = new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                // 重新設定記事項目
                itemAdapter.set(position, item);
                //true to indicate event consumed, won't trigger click
                return true;
            }
        };
    ...
    public void clickMenuItem(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.add_item:
                ...
                Intent intent = new Intent(Constants.ACTION_ADD_ITEM);
